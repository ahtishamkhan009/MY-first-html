                        ...
                        <div class="col-md-6">
                            <div class="contact-form">
                                <form>
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Your Requirment" required="required" />
                                    </div>
                                    <div class="form-group">
