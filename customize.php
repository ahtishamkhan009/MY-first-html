...
<html lang="en">
  ...
  <div class="form-group">
  <input type="Name" class="form-control" id="exampleInputPassword1" placeholder="Father Name">

  </div>
  <div class="form-group">
  <input type="Name" class="form-control" id="exampleInputPassword1" placeholder="C NIC">
